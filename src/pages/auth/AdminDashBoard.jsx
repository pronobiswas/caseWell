...
const AdminDashBoard = () => {
    ...
    // Good practice: Initialize Firebase outside the component or in a separate file
    ...
    // imgUrl state might not be strictly necessary for the submission logic,
    // but useful if you want to display the uploaded image immediately after selection.
    const [imgUrl, setImgUrl] = useState('');
    // New state to hold the fetched data and the loading status
...
const handleSubmit = async (e) => {
    ...
    let deleteUrlToSave = null; // New variable to store the delete URL
...
const handleDelete = async (id, deleteUrl) => {
    if (window.confirm("Are you sure you want to delete this item?")) {
        try {
            ...
            // Then, if a deleteUrl exists, delete the image from ImageBB
            if (deleteUrl) {
                // Extract the deletion key from the deleteUrl
