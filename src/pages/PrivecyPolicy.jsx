...
const PrivecyPolicy = () => {
    return (
        <>
            <section id="privecyPolicy" className='w-full h-full bg-bgOne pt-32 pb-20'>
                    ...
                    <div className=" priecyPolicyWrapper w-full max-w-5xl mx-auto p-5 xl:p-10">
                        ...
                        <div className='w-full flex flex-col gap-2 py-5'>
                            ...
                            <address className='ml-8'>
                                <p className='text-xl'><b>Zebrano Studio</b></p>
                        ...
                        <div className='w-full flex flex-col gap-2 p-5'>
                            ...
                            <ul>
                                <li>
                                    <p><b>Directly from You:</b> When you fill out contact forms, request a quote, place an order, subscribe to our newsletter, or communicate with us directly.</p>
                                </li>
                                <li>
                                    <p><b>Automatically: </b> Through cookies and similar technologies when you browse our website.</p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='w-full flex flex-col gap-2 py-5 lg:py-10'>
                            ...
                            <div className='p-5'>
                                ...
                                <div className='pl-5 p-2'>
                                    ...
                                    <p>Legal Basis: Legal obligation (GDPR Art. 6(1)(c)) or legitimate interest (Art. 6(1)(f)) in protecting our business.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='py-8 lg:py-10'>
                            ...
                            <ul className='pl-5 mt-2'>
                                <li>
                                    <p><b>Service Providers:</b> Third-party companies that perform services on our behalf, such as payment processing, website hosting, analytics, marketing, and delivery services. These providers are contractually obligated to protect your data and only use it for the purposes for which it was provided.</p>
                                </li>
                                <li>
                                    <p><b>Legal Requirements:</b>If required to do so by law or in response to valid requests by public authorities (e.g., a court order or government agency).</p>
                                </li>
                                <li><p><b>Business Transfers:</b> In connection with a merger, acquisition, or sale of all or a portion of our assets, your personal data may be transferred as part of that transaction.</p></li>
                            </ul>
                        </div>
                        ...
                        <div className='w-full'>
                            ...
                            <ul className='p-5'>
                                <li>
                                    <p><b>Right to Access (Art. 15 GDPR):</b> You have the right to request a copy of the personal data we hold about you.</p>
                                </li>
                                <li>
                                    <p><b>Right to Rectification (Art. 16 GDPR): </b> You have the right to request that we correct any inaccurate or incomplete personal data.</p>
                                </li>
                                <li>
                                    <p><b>Right to Erasure ("Right to Be Forgotten") (Art. 17 GDPR):</b> You have the right to request the deletion of your personal data under certain circumstances.</p>
                                </li>
                                <li>
                                    <p><b>Right to Restriction of Processing (Art. 18 GDPR):</b> You have the right to request that we restrict the processing of your personal data under certain conditions.</p>
                                </li>
                                <li>
                                    <p><b>Right to Data Portability (Art. 20 GDPR): </b>You have the right to receive your personal data in a structured, commonly used, and machine-readable format and to transmit it to another controller.</p>
                                </li>
                                <li>
                                    <p><b>Right to Object (Art. 21 GDPR):</b>You have the right to object to the processing of your personal data in certain situations, particularly when processing is based on legitimate interests or for direct marketing.</p>
                                </li>
                                <li>
                                    <p><b>Rights in Relation to Automated Decision-Making and Profiling (Art. 22 GDPR): </b> You have the right not to be subject to a decision based solely on automated processing, including profiling, which produces legal effects concerning you or similarly significantly affects you.</p>
                                </li>
                                <li>
                                    <p><b>Right to Withdraw Consent:</b> If we are processing your personal data based on your consent, you have the right to withdraw that consent at any time. This will not affect the lawfulness of processing based on consent before its withdrawal.</p>
                                </li>
                            </ul>
                            <p>To exercise any of these rights, please contact us using the contact details provided in Section 1. We will respond to your request within one month.</p>
                        </div>
