            ...
            <div className="hidden">
              ...
              >
                <g clip-path="url(#clip0_201_54)">
                  <path
                    d="M46.2617 98.8122H78.3281V109.818H32.8594V99.9239L64.8267 43.5621H32.8594V32.5559H78.3281V42.4503L46.2617 98.8122Z"
                    fill="white"
                  />
                  <path
                    d="M111.981 42.7836V65.4616H135.808V75.8009H111.981V99.4798H138.786V109.818H100.664V32.445H138.786V42.7836H111.981Z"
                    fill="white"
                  />
                  <mask
                    id="mask0_201_54"
                  ...
                  <g mask="url(#mask2_201_54)">
                    <path
                      d="M346.17 83.6935L334.952 47.7861L323.634 83.6935H346.17ZM349.347 94.0321H320.457L315.493 109.818H303.68L328.399 32.445H341.504L366.224 109.818H354.311L349.347 94.0321Z"
                      fill="white"
                    />
                  </g>
                  <mask
                  ...
                  <g mask="url(#mask3_201_54)">
                    <path
                      d="M443.562 109.818H432.245L398.193 52.1213V109.818H386.875V32.4454H398.193L432.245 90.0305V32.4454H443.562V109.818Z"
                      fill="white"
                    />
                  </g>
                  <mask
                  ...
                  <g mask="url(#mask5_201_54)">
                    <path
                      d="M217.289 131.487V139.755H202.6V193.277H193.549V139.755H178.781V131.487H217.289Z"
                      fill="white"
                    />
                  </g>
                  <mask
                  ...
                  <g mask="url(#mask6_201_54)">
                    <path
                      d="M243.324 131.486V170.871C243.324 175.555 244.422 179.081 246.619 181.451C248.815 183.823 251.872 185.008 255.79 185.008C259.759 185.008 262.842 183.823 265.039 181.451C267.235 179.081 268.334 175.555 268.334 170.871V131.486H277.386V170.693C277.386 175.732 276.406 180 274.448 183.496C272.489 186.994 269.869 189.602 266.588 191.32C263.305 193.04 259.68 193.898 255.71 193.898C251.741 193.898 248.128 193.04 244.872 191.32C241.618 189.602 239.037 186.994 237.131 183.496C235.226 180 234.273 175.732 234.273 170.693V131.486H243.324Z"
                      fill="white"
                    />
                  </g>
                  <mask
                  ...
                  <g mask="url(#mask8_201_54)">
                    <path
                      d="M370.363 193.277H361.312V131.487H370.363V193.277Z"
                      fill="none"
                    />
                  </g>
                  <mask
