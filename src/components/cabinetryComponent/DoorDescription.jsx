          ...
          <div ref={optionOneRef} className="cabinetaryOptionOne w-full h-full flex flex-col md:flex-row gap-5">
            ...
            <div className="optionOneCol w-full md:w-1/2 px-8 py-32 bg-colorTwo">
              ...
              <div className='flex flex-col gap-14 mt-5'>
                <h3 className='font-Montserrat text-3xl'>A Statement in Motion</h3>

                <p>Forget the ordinary swing — luxury pivot doors rotate from a central point, creating a smooth, weightless movement that feels more like a design experience than just an opening. Oversized or heavy? Not a problem — our custom pivot doors handle it effortlessly.</p>
                <Link to="/collection" >
            ...
            <div className="optionOneCol w-full md:w-1/2  px-8 py-32">
              ...
              <div className='flex flex-col gap-14 mt-5'>
                <h3 className='font-Montserrat text-3xl'>Bold, Seamless, Functional</h3>

                <p>A pivot door isn’t just an entrance — it’s a statement piece. Perfect for wide openings, modern pivot doors create a sense of arrival while keeping movement effortless and perfectly balanced..</p>
                <Link to="/inspiration" >
