                    ...
                    <div ref={optionOneRef} className="cabinetaryOptionOne w-full h-full flex flex-col md:flex-row gap-5">
                        ...
                        <div className="optionOneCol w-full md:w-1/2 px-8 py-32 bg-colorTwo">
                            ...
                            <div className='flex flex-col gap-14 mt-5'>
                                <h3 className='font-Montserrat text-3xl'>Space-Saving Elegance</h3>

                                <p>Sliding doors glide along a track instead of swinging open, making them ideal for space-conscious layouts. Our modern sliding doors work beautifully as statement room dividers or sleek wardrobe solutions.</p>
                                <Link to="/collection" >
                        ...
                        <div className="optionOneCol w-full md:w-1/2  px-8 py-32">
                            ...
                            <div className='flex flex-col gap-14 mt-5'>
                                <h3 className='font-Montserrat text-3xl'>Flexible & Functional</h3>

                                <p>Perfect for dividing spaces, hiding storage, or creating a seamless flow between rooms, our custom sliding doors offer practical solutions without compromising on design.
                                    Button: Get Inspired → Inspiration page.</p>
                                <Link to="/inspiration" >
