        ...
        <div className="timelineWrapper relative w-full h-full p-5 flex flex-col gap-5 lg:gap-20 2xl:gap-5">
            ...
            <div className="timeleineTxtCol w-full lg:w-1/2 2xl:w-2/3  flex gap-5 mb-[200px] lg:mb-0">
              ...
              <div className='textContiner w-full flex justify-center'>
                <div className=' textbox w-full lg:w-3/4'>
                  <h4 className='text-2xl font-myFont font-semibold'> Working with Nature, Not Against It</h4>
          ...
          <div className="timelineRow flex flex-col lg:flex-row">
            ...
            <div className="timeleineTxtCol w-full lg:w-1/2 2xl:w-2/3  flex gap-5 mb-[200px] lg:mb-0">
              ...
              <div className='textContiner w-full flex justify-center'>
                <div className=' textbox w-full lg:w-3/4'>
                  <h4 className='text-2xl font-myFont font-semibold'>2. Respect for the Material</h4>
          ...
          <div className="timelineRow flex flex-col lg:flex-row">
            ...
            <div className="timeleineTxtCol w-full lg:w-1/2 2xl:w-2/3  flex gap-5 mb-[200px] lg:mb-0">
              ...
              <div className='textContiner w-full flex justify-center'>
                <div className=' textbox w-full lg:w-3/4'>
                  <h4 className='text-2xl font-myFont font-semibold'>3. Design with Longevity in Mind</h4>
          ...
          <div className="timelineRow flex flex-col lg:flex-row">
            ...
            <div className="timeleineTxtCol w-full lg:w-1/2 2xl:w-2/3  flex gap-5 mb-[200px] lg:mb-0">
              ...
              <div className='textContiner w-full flex justify-center'>
                <div className=' textbox w-full lg:w-3/4'>
                  <h4 className='text-2xl font-myFont font-semibold'>Craftsmanship as a Sustainable Act</h4>
          ...
          <div className="timelineRow flex flex-col lg:flex-row">
            ...
            <div className="timeleineTxtCol w-full lg:w-1/2 2xl:w-2/3  flex gap-5 mb-[200px] lg:mb-0">
              ...
              <div className='textContiner w-full flex justify-center'>
                <div className=' textbox w-full lg:w-3/4'>
                  <h4 className='text-2xl font-myFont font-semibold'>Pride in Every Detail</h4>
