        ...
        <div className="wrapper w-full h-auto  p-5 py-20 md:p-10 md:pt-32 md:py-20 lg:pb-10 lg:pt-32 xl:pt-40 2xl:pb-20">
          ...
          <div className='w-full flex flex-col md:flex-row'>
            <div className='w-full md:w-1/2'>
              <h1 ref={headingTwoRef} className='w-fit text-5xl md:text-6xl font-Montserrat font-bold lg:text-[6vw] text-colorOne'>{headingTwo}</h1>
              <h1 ref={headingThreeRef} className='w-fit text-5xl md:text-6xl font-Montserrat font-bold lg:text-[6vw] text-colorOne'>{headingThree}</h1>
            </div>
            <div className="w-full md:w-1/2">
